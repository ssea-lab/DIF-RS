...
def argparser():
    ...
    # path
    parser.add_argument('-mp', '--model_path', metavar='MP', default='/ssd_data/lzw/DIF-RS/dif/algorithms/rlpnet/model/{}/rlpnet.ckpt',
                        type=str, help='model save path')
    parser.add_argument('-pp', '--pkl_path', metavar='PP', type=str, default='/ssd_data/lzw/DIF-RS/dif/algorithms/rlpnet/config/config.pkl',
                        help='pkl save path')
...
def pkl_parser():
    parser = argparse.ArgumentParser()
    file_path = '/ssd_data/lzw/DIF-RS/dif/algorithms/rlpnet/config/config.pkl'
