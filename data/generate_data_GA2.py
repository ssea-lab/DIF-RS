...
from GA2 import genetic_algorithm
# 定义输入文件和输出文件
input_file = './val/alibaba_cluster_trace.txt'
output_file = './val/GA2/alibaba_cluster_trace_50.txt'
print(sys.path)
# 读取数据
...
with open(output_file, "w+", encoding='utf-8') as file:
    for index,item in tqdm(enumerate(data), total=len(data), desc="Processing items"):
        ...
        if (index +1) % 50 == 0:
            ...
            idx_list = genetic_algorithm(task_list)[0]
