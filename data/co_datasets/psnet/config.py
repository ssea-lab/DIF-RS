...
def argparser():
    ...
    parser.add_argument('-b', '--batch', metavar='B', type=int, default=5, help='batch size, default: 128')
    ...
    # path
    parser.add_argument('-mp', '--model_path', metavar='MP', default='./co_datasets/psnet/model/{}/psnet.ckpt',
                        type=str, help='model save path')
    parser.add_argument('-pp', '--pkl_path', metavar='PP', type=str, default='./psnet/config/config.pkl',
                        help='pkl save path')
...
def pkl_parser():
    parser = argparse.ArgumentParser()
    file_path = './co_datasets/psnet/config/config.pkl'
